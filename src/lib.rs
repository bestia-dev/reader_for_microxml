//! reader_for_microxml
//! 2020-01-12  Luciano Bestia ver. 1.0.0.

//! ## Description
//! TODO: copy doc from readme
//!
...
//! I am not trying to return errors for all the possible incorrectness in microXml.
//! Only the basic incorrectness produce errors.

/// Reader for MicroXml - the Class
/// Rust has Structs + Traits, but for me it is like an Class/Object.
